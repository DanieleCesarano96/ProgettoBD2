					...
					<table class="table table-striped">
						...
						<tr class="pt-1" id="lista">
							<td style="border-style: none"><a
								href="VisualizzaDettagliTesiServlet?propostatesi_id=">Libro1</a>
							</td>
							<td style="border-style: none">
								 <a class="btn bg-warning"
								href="ModificaPropostaTesiServlet?propostatesi_id=&propostatesi_titolo=&propostatesi_ambito=&propostatesi_tempo=&propostatesi_descrizione=&propostatesi_materia="><small
